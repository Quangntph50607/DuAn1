 ...
 * @author DUNG
 */
public class ViewQuanLy1 extends javax.swing.JFrame {
    ...
    private void jLabel12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel12MouseClicked
        ...
        try {
            ...
            Logger.getLogger(ViewQuanLy1.class.getName()).log(Level.SEVERE, null, ex);
        }
        jDesktopPane1.removeAll();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewQuanLy1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewQuanLy1().setVisible(true);
            }
        });
    }
